              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive mt-3">
                          <button class="btn btn-primary mb-4" data-toggle="modal" data-target="#memberFormModal">Add new user <i class="icon-circle-plus" ></i></button>
                              ...
                              <div class="modal-body p-4">
                                <form id="memberForm">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text"  name="fullname" class="form-control" id="fullname" placeholder="Enter the fullname e.g Mark Van Nester">
                                  </div>
                                  <div class="form-group">
                      ...
                      <table class="table table-header-bg" id="tblist" data-page-length='25'>
                        <thead>
                      </div>
                          <tr>
                            <th>
