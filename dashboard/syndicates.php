...
<head>
  ...
  <title>Dashboard - Syndicates</title>
  <!-- base:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-xl-12 grid-margin-lg-0 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-center">Syndicates</h4>
                    <div class="table-responsive mt-3">
                      <table class="table table-header-bg" id="tb_list_syndicates"  data-order='[[ 1, "asc" ]]' data-page-length='25'>
                        <thead>
                          <tr>
                            <th>
                                Racing
